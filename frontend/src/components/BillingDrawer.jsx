...
import { Crown, Key, X } from 'lucide-react'
        ...
        <AnimatePresence>
            ...
            />
                <motion.div
                    ...
                    className='fixed right-0 top-0  h-screen w-95 bg-[#0f1117] border-l border-white/10 shadow-2xl flex flex-col z-50'
                >
                    ...
                    <div className='px-5 flex-1 overflow-auto space-y-4'>
                        ...
                        text-white cursor-pointer'onClick={() => handleUpgrade("starter")}>Upgrade</button>
                        </div>
                         ...
                         <div className='rounded-xl border border-white/10 p-4'>
                            ...
                            <button className='mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2
                        text-white cursor-pointer'onClick={() => handleUpgrade("pro")}>Upgrade</button>
                        </div>
                    </div>
