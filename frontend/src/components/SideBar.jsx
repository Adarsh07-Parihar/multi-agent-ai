...
function SideBar() {
  ...
  if (collapsed) {
    return (
      <div className='hidden lg:flex flex-col items-center w-14 h-screen bg-[#0d0f14] border-r
      border-white/6 py-4 gap-1 shrink-0'>
        <button className='flex items-center justify-center w-9 h-9 rounded-xl
                 bg-transparent text-slate-500 cursor-pointer mb-1
        ...
        <button className='flex items-center justify-center w-9 h-9 rounded-xl
                 bg-transparent text-slate-500 cursor-pointer border-none
                hover:text-slate-200 hover:bg-white/5 transition-colors duration-150'
        ...
        <div className='flex-1 overflow-y-auto px-2.5 pb-2 scrollbar-none [& ::-webkit-scrollbar]:hidden pt-5'>
          {conversations.map((conv, i) => {
            ...
            return (
              <div onClick={() => dispatch(setSelectedConversation(conv))} className={`flex items-center gap-2.5 cursor-pointer mb-0.5 px-3 py-2.5
            rounded-[10px] border transition-colors duration-150
            ${isActive ? "bg-indigo-500/10 border-indigo-500/18" :
        ...
        <div className='relative shrink-0'>
                {
                 ...
                 border-indigo-500/25'
                    ...
                    :
                    <div className='w-9 h-9 rounded-[10px] bg-white/6 flex
  ...
  return (
    <>
      ...
      h-8 rounded-lg bg-[#0d0f14] border border-white/6 text-slate-400 hover:text-slate-200
    ...
    bg-[#0d0f14] border-r border-white/6 
     transition-transform duration-250
      ...
      <div className='flex flex-col h-full'>
        ...
        hover:text-slate-200 hover:bg-white/5 transition-colors duration-150 bg-transparent
        border-none cursor-pointer' onClick={()=>dispatch(setSelectedConversation(null))}>
            <PenSquare size={14} />
          </button>
        </div>
        ...
        <div className='px-4 pt-4 pb-1'>
          ...
          hover:opacity-90 transition-opacity duration-150' onClick={()=>dispatch(setSelectedConversation(null))}>
            <Plus size={15} />
            New Chat
          </button>
        </div>
        ...
        <div className='px-3.5 py-3.5'>
          {userData ? (
            ...
            hover:bg-white/5 transition-colors duration-150'>
              ...
              <div className='flex gap-1'>
                ...
                border-none bg-transparent text-yellow-600 cursor-pointer hover:bg-white/8
                hover:text-slate-400 transition-all duration-150'>
                  <Coins size={16} />
                </button>
                <button className='flex items-center justify-center w-7 h-7 rounded-[7px]
                border-none bg-transparent text-slate-600 cursor-pointer hover:bg-white/8
                hover:text-slate-400 transition-all duration-150'
                  onClick={() => {
                    logOut();
          ...
          text-slate-200 bg-white/5 border border-white/8 rounded-xl py-2.75
