...
function MessageBubble({ role, content, images }) {
    ...
    return (
        <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
            <div className={`max-w-[92vw] px-4 py-2.5 rounded-2xl md:max-w-[72%] overflow-hidden w-fit wrap-break-word leading-relaxed
            ${isUser
                ...
                <Markdown remarkPlugins={[remarkGfm]}
                    components={{
                        ...
                        a: ({ href, children, ...props }) => (
                            <a
                                href={href} // 👈 THIS WAS MISSING!
                                target='_blank'
                                rel='noopener noreferrer' // 'noopener' is a good security practice
                                className='text-indigo-400 underline inline-flex items-center gap-1 cursor-pointer relative z-10'
                                {...props}
                            >
                                {children}
            ...
            {lightBox &&
                <div className='fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-6'>
                    ...
                    <img
                        src={lightBox}
                        className='max-w-[90vh] max-h-[85vh] rounded-2xl border border-white/10 shadow-2xl object-contain'
                    />
                </div>
            }
        </div>
